  ...
  return (
    <div className="bg-indigo-900 mx-auto w-full text-white p-8 flex flex-col gap-2 justify-center items-center">
      ...
      <div className="flex space-x-4 justify-center items-center">
        <Image src="/images/mindsdbim.png" alt="mindsdb" width={50} height={50} priority />
        <Image src="/images/supabase-logo-wordmark--dark.png" alt="supabase" width={100} height={100} priority />
      </div>
